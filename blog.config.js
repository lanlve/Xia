...
const BLOG = {
  AUTHOR: 'InSummer', // 作者
  BIO: '因为有我，这个世界会有些小小的不一样。', // 作者简介
  LINK: 'https://summer.tk', // 网站地址
  ...
  CONTACT_EMAIL: 'walxl1988@gmail.com',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: '',
  CONTACT_TELEGRAM: '',
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '夏日の香气', // 站点标题 ，被notion中的页面标题覆盖
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '记录|回望', // 站点描述，被notion中的页面描述覆盖
